...
impl Provider for KlaApiClient {
...
mod tests {
    ...
    use super::{
        ...
        resolve_startup_auth_source, AuthSource, KlaApiClient, OAuthTokenSet,
    };
    ...
    fn backoff_doubles_until_maximum() {
        let client = KlaApiClient::new("test-key").with_retry_policy(
            3,
